...
/**
 * @link https://docs.pinecone.io/guides/inference/rerank
 */
class Rerank extends Request implements HasBody
{
    ...
    {
        // Assuming '/rerank' endpoint based on common patterns and examples.
        // The official API reference should confirm this.
        return '/rerank';
    }
